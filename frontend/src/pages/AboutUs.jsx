    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="max-w-4xl bg-white rounded-lg shadow-lg p-8">
        ...
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          Welcome to <span className="font-bold text-blue-500">Taskify</span>, your ultimate task management tool. 
          Whether you're a professional balancing work deadlines or a student organizing your studies, 
          Taskify is here to help you stay on top of your responsibilities.
        </p>
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          With a simple and intuitive interface, Taskify makes it easy to plan, prioritize, 
        ...
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          ...
          Whether it's for personal or professional use, Taskify is your companion for achieving more, one task at a time.
        </p>
        {/* Quote */}
        <blockquote className="text-gray-600 italic border-l-4 border-blue-500 pl-4">
          "An organized life is a happy life. Start your journey with Taskify today!"
        </blockquote>
      </div>
    </div>
  );
